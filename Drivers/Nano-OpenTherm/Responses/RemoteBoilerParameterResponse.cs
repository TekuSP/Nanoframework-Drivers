...
{
    public class RemoteBoilerParameterResponse : Response, IRemoteParameterTransferEnable, IRemoteParameterTransferReadWrite
    {
    ...
    protected RemoteParameterTransferReadWrite RemoteParameterTransferReadWrite { get; set; }
        ...
        {
            var low = Utilities.SetRemoteParameterTransferEnable(RemoteParameterTransferEnable);
            var high = Utilities.SetRemoteParameterTransferReadWrite(RemoteParameterTransferReadWrite);
