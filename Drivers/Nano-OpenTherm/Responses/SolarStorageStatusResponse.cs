...
{
    /// <summary>Solar Storage status flags response (low=MasterStatus, high=SlaveStatus).</summary>
    public class SolarStorageStatusResponse : Response, IMasterStatus, ISlaveStatus
    {
        #region Public Constructors

        public SolarStorageStatusResponse(MessageType mt = MessageType.READ_ACK)
        { MessageType = mt; }
