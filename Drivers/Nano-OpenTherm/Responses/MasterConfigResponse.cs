...
{
    public class MasterConfigResponse : Response, IMasterConfiguration, IMemberIdCode
    {
        #region Public Constructors

        public MasterConfigResponse(MessageType mt = MessageType.READ_ACK)
        { MessageType = mt; }
        ...
        // IMemberIdCode (full mapping like in SlaveConfigResponse)
        ...
        // IMasterConfiguration (Reserved bits 0..7)
        public bool MasterConfigReserved0 { get => MasterConfiguration.IsSet(MasterConfiguration.Reserved0); set => MasterConfiguration = MasterConfiguration.SetFlag(MasterConfiguration.Reserved0, value); }

        public bool MasterConfigReserved1 { get => MasterConfiguration.IsSet(MasterConfiguration.Reserved1); set => MasterConfiguration = MasterConfiguration.SetFlag(MasterConfiguration.Reserved1, value); }
        public bool MasterConfigReserved2 { get => MasterConfiguration.IsSet(MasterConfiguration.Reserved2); set => MasterConfiguration = MasterConfiguration.SetFlag(MasterConfiguration.Reserved2, value); }
        public bool MasterConfigReserved3 { get => MasterConfiguration.IsSet(MasterConfiguration.Reserved3); set => MasterConfiguration = MasterConfiguration.SetFlag(MasterConfiguration.Reserved3, value); }
        public bool MasterConfigReserved4 { get => MasterConfiguration.IsSet(MasterConfiguration.Reserved4); set => MasterConfiguration = MasterConfiguration.SetFlag(MasterConfiguration.Reserved4, value); }
        public bool MasterConfigReserved5 { get => MasterConfiguration.IsSet(MasterConfiguration.Reserved5); set => MasterConfiguration = MasterConfiguration.SetFlag(MasterConfiguration.Reserved5, value); }
        public bool MasterConfigReserved6 { get => MasterConfiguration.IsSet(MasterConfiguration.Reserved6); set => MasterConfiguration = MasterConfiguration.SetFlag(MasterConfiguration.Reserved6, value); }
        public bool MasterConfigReserved7 { get => MasterConfiguration.IsSet(MasterConfiguration.Reserved7); set => MasterConfiguration = MasterConfiguration.SetFlag(MasterConfiguration.Reserved7, value); }
