...
{
    /// <summary>Ventilation/HR S-Config & MemberID response (low=SlaveConfiguration, high=MemberIdCode).</summary>
    public class VentilationSConfigResponse : Response, ISlaveConfiguration, IMemberIdCode
    {
        #region Public Constructors

        public VentilationSConfigResponse(MessageType mt = MessageType.READ_ACK)
        { MessageType = mt; }
        ...
        // IMemberIdCode convenience selectors (full set, backing is protected enum)
        ...
        protected override uint GetRawDataCore()
        {
            ...
            return ProcessResponse(Utilities.MakeUShort((byte)MemberIdCode, low));
        }
