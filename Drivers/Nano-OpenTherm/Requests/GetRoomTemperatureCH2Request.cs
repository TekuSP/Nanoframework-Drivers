...
namespace TekuSP.Drivers.Nano_OpenTherm.Requests
{
    ...
    public class GetRoomTemperatureCH2Request : ReadRequest, IMasterStatus
    {
        ...
        /// <summary>
        /// Convenience constructor to initialize master status (LB) bits for CH2.
        /// </summary>
        public GetRoomTemperatureCH2Request(MS status)
            : base()
        {
            MasterStatus = status;
        }
        ...
        /// <summary>
        /// Master status flags (low byte). Single source of truth for IMasterStatus.
        /// </summary>
