...
namespace TekuSP.Drivers.DriverBase.Interfaces
{
    ...
    public interface IHumiditySensor
    {
        ...
        RelativeHumidity CalculateHumidity(RelativeHumidityUnit readHumidityType, double rawHumidity);
        ...
        RelativeHumidity ReadHumidity(RelativeHumidityUnit readHumidityType);
